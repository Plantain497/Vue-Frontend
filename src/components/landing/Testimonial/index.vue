<template>
	<div class="py-12 overflow-hidden bg-gray-100 md:py-20 lg:py-24">
		<div class="relative max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
			<svg
				class="absolute transform top-full right-full translate-x-1/3 -translate-y-1/4 lg:translate-x-1/2 xl:-translate-y-1/2"
				width="404"
				height="404"
				fill="none"
				viewBox="0 0 404 404"
			...
			<div class="relative">
				<svg class="h-10 mx-auto" fill="none" viewBox="0 0 180 40">
					<path
						fill="#2D3748"
