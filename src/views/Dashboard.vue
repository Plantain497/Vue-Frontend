<template>
	<div class="px-2 py-8 mx-auto bg-gray-100 max-w-7xl sm:px-6 lg:px-8">
		...
		<modal :open="showModal" @action="modelClose" @cancel="showModal = false">
					...
					<div class="sm:flex sm:items-start">
						...
						<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
							...
							<div class="mt-2">
								...
								>Are you sure you want to deactivate your account? All of your data will be permanantly removed. This action cannot be undone.</p>
							</div>
						</div>
					</div>
				</div>
